...
public static class IEnumerableExtensions
{
	...
	{
		return enumerable.ElementAt(StaticRandom.Rand.Next(enumerable.Count()));
	}
	...
	public static T RandomOrDefault<T>(this IEnumerable<T> enumerable)
	{
		...
		return enumerable.ElementAt(StaticRandom.Rand.Next(enumCount));
	}
	...
	/// <returns></returns>
	public static T Random<T>(this IEnumerable<T> enumerable, params IEnumerable<T>[] additionalEnumerables)
	{
		...
		int result = StaticRandom.Rand.Next(allEnumsCount);
